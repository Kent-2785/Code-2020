...
public class DriveTrain extends SubsystemBase {
  ...
  public double FLEgetDistance()
  {
    frontLeftEncoder.setDistancePerPulse(1.0 / 360.0 * 2.0 * Math.PI * 1.5);
     return frontLeftEncoder.getDistance();
  
  }
  public double FREgetDistance()
  {
    frontRightEncoder.setDistancePerPulse(1.0 / 360.0 * 2.0 * Math.PI * 1.5);
     return frontRightEncoder.getDistance();
  
  }
  public double BREgetDistance()
  {
    backRightEncoder.setDistancePerPulse(1.0 / 360.0 * 2.0 * Math.PI * 1.5);
     return backRightEncoder.getDistance();
  
  }
  public double BLEgetDistance()
  {
    backLeftEncoder.setDistancePerPulse(1.0 / 360.0 * 2.0 * Math.PI * 1.5);
